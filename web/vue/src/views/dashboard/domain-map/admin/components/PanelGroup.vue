      ...
      <div class="card-panel" @click="handleSetLineChartData('total_domain')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-info flex-container">  
            ...
            <count-to :start-val="0" :end-val="98041" :duration="2600" class="card-panel-num" />  
      ...
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-info flex-container">  
            ...
            <count-to :start-val="0" :end-val="38979.1" :duration="2600" class="card-panel-num" />  
            <span class="card-panel-text">万条</span>  
          </div>  
          <div class="card-panel-text">
            统计日期：2024年5月-2025年4月
          </div>
        </div>
      </div>
    </el-col>
      ...
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-info flex-container">  
            ...
            <count-to :start-val="0" :end-val="3319.6" :duration="2600" class="card-panel-num" />  
            <span class="card-panel-text">万条</span>  
          </div>  
          <div class="card-panel-text">
            统计日期：2025年4月1日-28日
