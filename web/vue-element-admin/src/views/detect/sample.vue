...
export default {
  ...
  methods: {
    ...
    try {      
      const response = await fetch('http://10.134.2.27:5000/upload', {      
        method: 'POST',      
        body: formData,      
      });    
  ...
  axios.get(`http://10.134.2.27:5000/detection_API/${sha256}`, { params: { VT_API: VT_API } })  
  ...
  axios.get(`http://10.134.2.27:5000/behaviour_API/${sha256}`, { params: { VT_API: VT_API } })  
